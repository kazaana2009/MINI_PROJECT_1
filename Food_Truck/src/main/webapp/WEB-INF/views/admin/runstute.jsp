				...
				<div class="pagination" align="center">
					<ul>
						<%
							...
							if (currentPage > 1) {
							%>
								<li><a href="run?pageNo=<%=currentPage - 1%>"><i class="fa fa-angle-left"></i><</a></li>
							<%
							} 
								...
								%>
									<li><a href="run?pageNo=<%=iCount%>"><%=iCount%></a><li>
								<%
									}
								}
								if (currentPage < totalPage) {
								%>
									<li><a href="run?pageNo=<%=currentPage + 1%>"><i class="fa fa-angle-right">></i></a></li>
							<%
								}
								if (endPage < totalPage) {
								%>
