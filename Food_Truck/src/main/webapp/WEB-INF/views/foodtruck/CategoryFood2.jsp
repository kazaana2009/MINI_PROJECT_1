		...
		<div class="col-md-9">
			<div class="row">
				<div class="shop-tool-bar col-sm-12 fix">
					<div class="view-mode">
						<a href="/CategoryFood2?pageNo=1&category=${categoryno}'0'].category}" class="active">
							<i class="fa fa-th"></i>
						</a>
						<a href="/CategoryFood?pageNo=1&category=${categoryno}">
					...
					<div class="pagination">
						<ul>
							<%
								...
								if (startPage > 1) {
							%>
							<li><a href="CategoryFood2?pageNo=1&category=<%=request.getAttribute("categoryno")%>">처음</a></li>
							<%
								}
								if (currentPage > 1) {
							%>
							<li><a href="CategoryFood2?pageNo=<%=currentPage - 1%>&category=<%=request.getAttribute("categoryno")%>"><i class="fa fa-angle-left"></i></a></li>
							<%
								}
							...
							%>
							<li><a href="CategoryFood2?pageNo=<%=iCount%>&category=<%=request.getAttribute("categoryno")%>"><%=iCount%></a><li>
							<%
								}
								}
								if (currentPage < totalPage) {
							%>
							<li><a href="CategoryFood2?pageNo=<%=currentPage + 1%>&category=<%=request.getAttribute("categoryno")%>"><i class="fa fa-angle-right"></i></a></li>
							<%
								}
								if (endPage < totalPage) {
							%>
