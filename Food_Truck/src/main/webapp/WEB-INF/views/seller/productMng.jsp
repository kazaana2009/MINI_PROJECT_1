...
<%@include file="../comm/header2.jsp" %>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="muted pull-left">푸드트럭 명
				<select name="licenseNo" style="border:0px">
					<option>선택해주세요.</option>
					<c:forEach var="license" items="${license}">
						<option value="${license.licenseNo}">${license.licenseNo}</option>
					</c:forEach>
				</select>
			</div>
			</div>
				...
				<div class="row-fluid">
						...
						<div class="block">
							<div class="navbar navbar-inner block-header">
								<div class="muted pull-left">메뉴 리스트</div>
								<div class="pull-right">
